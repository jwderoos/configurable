...
class InvalidCallbackWrongReturnTypeService
{
    use ConfigurableServiceTrait;

    public function isSupported(ConfigurableServiceConfigurationInterface $configurableServiceConfiguration): string
    {
        return 'yes';
    }
}
